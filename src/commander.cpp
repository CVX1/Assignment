...
// Commander Class
//--------------------------------------------------------------------------
bool Commander::get_ex() {return ex;}

bool Commander::runNext(bool exec, Instruction* conn) {
...
bool Commander::execute(CmdString cs) {
    //cout << "EXECUTE" << endl;
    ...
    do {
        ...
        if ((strcmp(cs.V[count]->str, "exit") == 0 || strcmp(cs.V[count]->str, "Exit") == 0 || strcmp(cs.V[count]->str, " exit") == 0 || strcmp(cs.V[count]->str, " Exit") == 0) && run == true) {
            ex = true;
        }
        ...
        //
        //e.g. (echo a && echo b); echo c -> true; echo c
